    ...
    <div class="col-lg-12">
        ...
        <div class="card my-2 border-success">
            <div class="card-header bg-success text-white">
                <a href="addCeride.php?taskId=<?php echo $_GET["taskId"]; ?>"><button type="button" class="btn btn-success float-right">YENİ EKLE</button></a><a href="actions.php?export=excel&tablo=ceride&taskId=<?php echo $_GET["taskId"]; ?>"><button type="button" class="btn btn-success float-right"><i class="fa fa-download" aria-hidden="true"></i></button></a><h4 class="m-1">Ceride Kayıtları</h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function fetchAllCeride(){
            $.ajax({
                url: 'actions.php',
                method: 'post',
                data: {action:'fetchAllCeride',taskId:'<?php echo $_GET["taskId"]; ?>'},
                success:function(response){
