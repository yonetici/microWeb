    ...
    <div class="col-lg-12">
        ...
        if(isset($_GET["addNewUser"]) && $_GET["addNewUser"]==1) {
            ...
            <div class="bg-danger d-flex justify-content-center card my-2">
                <p class="text-center lead align-self-center text-white m-2">Yeni haber başarıyla eklendi.</p>
            </div>
            <?php
        }
        if(isset($_GET["editNews"]) && $_GET["editNews"]==1) {
            ?>
            <div class="bg-danger d-flex justify-content-center card my-2">
                <p class="text-center lead align-self-center text-white m-2">Haber başarıyla düzenlendi.</p>
            </div>
            <?php
        }
        ...
        <div class="card my-2 border-success">
            <div class="card-header bg-success text-white">
                <a href="addVideoNews.php"><button type="button" class="btn btn-success float-right">YENİ EKLE</button></a><h4 class="m-1">Video Haberler</h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function(){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: 'actions.php',
                        type: 'post',
                        data: { videoHaber_id: videoHaber_id },
                        success: function(response) {
        ...
        function fetchAllVideoNews(){
            $.ajax({
                url: 'actions.php',
                method: 'post',
                data: {action:'fetchAllVideoNews'},
                success:function(response){
