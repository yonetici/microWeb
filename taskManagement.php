    ...
    <div class="col-lg-12">
        ...
        if(isset($_GET["addNewUser"]) && $_GET["addNewUser"]==1) {
            ...
            <div class="bg-danger d-flex justify-content-center card my-2">
                <p class="text-center lead align-self-center text-white m-2">Yeni olay başarıyla eklendi.</p>
            </div>
            <?php
        }
        if(isset($_GET["editNews"]) && $_GET["editNews"]==1) {
            ?>
            <div class="bg-danger d-flex justify-content-center card my-2">
                <p class="text-center lead align-self-center text-white m-2">Olay başarıyla düzenlendi.</p>
            </div>
            <?php
        }
        ...
        <div class="card my-2 border-success">
            <div class="card-header bg-success text-white">
                <a href="addTask.php"><button type="button" class="btn btn-success float-right">YENİ EKLE</button></a><a href="actions.php?export=excel&tablo=olay"><button type="button" class="btn btn-success float-right"><i class="fa fa-download" aria-hidden="true"></i></button></a><h4 class="m-1">Olaylar</h4>
            </div>
            <div class="card-body">
