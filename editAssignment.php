...
if (isset($_GET["taskId"])) {
    ...
    $getTask = $admin->fetchAssignment($taskId);
    /** Kullanıcı Kontrolu */
    if ($admin->checkUserStatus($_SESSION['uye_id'])!=2 && $admin->checkUserStatus($_SESSION['uye_id'])!=5) {
            Header("Location:assignmentManagement.php?editNews=Izinsiz-Erisim");
            exit();
    }
                ...
                <form method="POST" action="process.php?action=editAssignment&haber_id=<?php echo $getTask["gorevlendirme_id"]; ?>" id="addUserForm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="gorev_yeri" required="" class="form-control">
                            <option value="<?php echo $getTask["gorev_yeri"]; ?>"><?php echo $getTask["gorev_yeri"]; ?></option>
                    ...
                    <select name="kategori_id" required="" class="form-control">
                        ...
                        foreach ($catList as $cat) {
                            ?>
                            <option value="<?php echo $cat['gorev_turu_id']; ?>" <?php echo ($cat['gorev_turu_id'] == $getTask['gorev_turu_id'] ? ' selected' : ''); ?>><?php echo $cat['gorev_turu_isim']; ?></option>
                        <?php } ?>
                    </select>
                    <br>
...
<script type="text/javascript">
    ...
    <?php
    $date = new DateTime($getTask['gorevlendirme_baslangic']);
    ...
    <?php
    $date1 = new DateTime($getTask['gorevlendirme_bitis']);
